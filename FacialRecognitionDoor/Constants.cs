namespace FacialRecognitionDoor
{
    ...
    {
        public const string InitialGreetingMessage = "Welcome to the MDS! Speech has been initialized.";
        ...
        {
            return "Welcome to the MDS " + visitorName + "! I will open the door for you.";
        }
    }
    ...
    public static class GpioConstants
    {
        ...
        public const int ButtonPinID = 62;
